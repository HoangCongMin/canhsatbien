    ...
    return (
        <div className='w-[23%] cursor-pointer  max-[1300px]:w-full rounded-full pb-5 max-[1300px]:flex-col'>
            <div className='w-full'>
                <img
                    className='w-[93px] h-[95px]  rounded-full max-[1300px]:rounded-full  max-[1300px]:w-36   max-[1300px]:h-36 m-auto  object-cover  group-hover:scale-110 transition duration-300 ease-in-out hover:brightness-50   max-[550px]:w-[83px] max-[550px]:h-[85px]'
