  ...
  return (
    <Link
      ...
      className={classNames(
        `text-[#182940] text-[15px] first:text-[18px]  font-medium	w-full h-full m-auto grid  grid-cols-4 grid-rows-1  gap-x-3   max-[1000px]:flex-col first:flex-col first:flex  ${
          classItem_all
            ? 'text-[10px]'
    ...
    >
      <div className={classNames(`overflow-hidden cursor-pointer col-span-2 relative group shadow-xl pt-[66.6667%] `)}>
        <img
      ...
      <div className='w-full max-[1000px]:w-full col-span-2'>
        ...
        {content && <div className='text-[14px] mt-1 text-[#3B4E68] line-clamp-3'>{content}</div>}
