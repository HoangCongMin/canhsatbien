...
export default function Item_In_Chart_Item({
  ...
  return (
    <div
      className={classNames(`${class_child ? class_child : 'w-[20%] '} m-auto bg-[#F6F6F6] py-4 font-bold rounded-lg  `)}
    >
      <div className='text-[#031739] text-[12px] hover:text-[#191970]  max-[1250px]:text-[12px] max-[800px]:text-[8px] line-clamp-2 max-[1100px]:text-[10px] max-[800px]:line-clamp-1'>{title__Organization}</div>
