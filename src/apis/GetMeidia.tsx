...
export const GetLongFormDetail=(id:number)=>http.get(`Layout/GetLongFormDetail?id=${id}`)
export const GetImage_detail=(id:number)=>http.get(`Layout/GetImage_detail?id=${id}`)
export const GetItem_detail=(id:number)=>http.get(`ItemDetail/Item_Detail?id=${id}`)
