...
export default function Media() {
  return (
    <div className='w-full '>
      ...
      <div className='w-full'>
        <div className='w-[80%] m-auto max-w-screen-2xl mt-9'>
          <List_New_All_Item data={List_Data_media_product} />
        </div>
      </div>
      <div className='w-full'>
        <div className='w-[80%] m-auto max-w-screen-2xl mt-12 border-t-2 border-[#dc2c2c]'>
      ...
      <div className='w-full'>
        <div className='w-[80%] m-auto flex justify-between max-w-screen-2xl mt-12 max-[1300px]:flex-col'>
