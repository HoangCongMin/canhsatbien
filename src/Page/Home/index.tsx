...
export default function Home() {
  ...
  return (
    <div className='w-full mt-4 mb-10'>
      ...
      <div className='w-[80%] m-auto flex justify-between mt-7 max-w-screen-2xl max-[1100px]:flex-col max-[850px]:flex-col overflow-auto '>
        <div className='w-[72%] max-[1300px]:w-[65%] flex justify-between max-[1300px]:flex-col max-[850px]:w-[100%] max-[1100px]:w-[100%] '>
          <Box_Call />
          ...
          <div>
            ...
            <div className='w-full text-center text-[16px] font-bold hover:text-[#191970] py-2'>
              ...
              <img
                ...
                alt=''
                className='w-[95%] m-auto py-2 h-[122px] max-[1100px]:h-[220px]'
              />
              <img
